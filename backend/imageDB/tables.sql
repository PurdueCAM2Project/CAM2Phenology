...
(
	...
	date_taken datetime,
	unique key(imagehash, dataset_id, date_taken),
	url varchar(2083),
	source varchar(50),
	x_resolution int,
	y_resolution int,
...
insert into users(user_name) values("Ehren Phenology");
...
insert into datasets (name, user_id) values("test1", 1);
insert into datasets (name, user_id) values('test2', 1);
